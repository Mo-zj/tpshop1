...
class BaseAction:
    ...
    def find_toast(self, message, is_screecshot=False, screenshot_name=None, timeout=3, poll=0.1):
        """
    ...
    def is_toast_exist(self, message, is_screecshot=False, screenshot_name=None, timeout=3, poll=0.1):
        try:
            self.find_toast(message, is_screecshot, screenshot_name, timeout, poll)
            return True
        except Exception:
            return False
